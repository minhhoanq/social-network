export const InstagramTextIcon = ({ width = '10.3rem', height = '2.9rem', className }) => (
    <svg
        className={className}
...
export const ReelsIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        ...
        viewBox="0 0 24 24"
    >
        <line fill="none" stroke="currentColor" strokeWidth={'2'} x1="2.049" x2="21.95" y1="7.002" y2="7.002"></line>
        <line
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
...
export const MorePostIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
...
export const SavedIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Save"
        className={className}
        color="rgb(38, 38, 38)"
...
export const MesageIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        aria-label=""
        className={className}
...
export const EmojiIcon = ({ width = '1.3rem', height = '1.3rem', className }) => (
    <svg
        aria-label="Emoji"
        className={className}
        color="rgb(142, 142, 142)"
...
export const YouractivityIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
...
export const SavedMoreIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Saved"
        className={className}
        color="rgb(38, 38, 38)"
...
export const ReportAProblemIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
