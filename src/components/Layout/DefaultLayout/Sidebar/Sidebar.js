                            ...
                            <Link className={cx('common_link')}>
                                <div className={cx('common_wrapper')}>
                                    <div className={cx('common_wrapper_temp')}>
                                        ...
                                        <Button scale className={cx('common_logo')} leftIcon={<HomeIcon />}>
                                            <div className={cx('common_text')}>Home</div>
                                        </Button>
                                    </div>
                                </div>
                            ...
                            <Link className={cx('common_link')}>
                                <div className={cx('common_wrapper')}>
                                    <div className={cx('common_wrapper_temp')}>
                                        ...
                                        <Button scale className={cx('common_logo')} leftIcon={<SearchIcon />}>
                                            <div className={cx('common_text')}>Search</div>
                                        </Button>
                                    </div>
                                </div>
                            ...
                            <Link className={cx('common_link')}>
                                <div className={cx('common_wrapper')}>
                                    <div className={cx('common_wrapper_temp')}>
                                        ...
                                        <Button scale className={cx('common_logo')} leftIcon={<ExploreIcon />}>
                                            <div className={cx('common_text')}>Explore</div>
                                        </Button>
                                    </div>
                                </div>
                            ...
                            <Link className={cx('common_link')}>
                                <div className={cx('common_wrapper')}>
                                    <div className={cx('common_wrapper_temp')}>
                                        ...
                                        <div className={cx('common_text')}>ReelsIcon</div> */}

                                        <Button scale className={cx('common_logo')} leftIcon={<ReelsIcon />}>
                            ...
                            <Link className={cx('common_link')}>
                                <div className={cx('common_wrapper')}>
                                    <div className={cx('common_wrapper_temp', 'focus')}>
                                        ...
                                        <Button scale className={cx('common_logo')} leftIcon={<MessagesIcon />}>
                                            <div className={cx('common_text')}>Messages</div>
                                        </Button>
                                    </div>
                                </div>
                            ...
                            <Link className={cx('common_link')}>
                                <div className={cx('common_wrapper')}>
                                    <div className={cx('common_wrapper_temp')}>
                                        ...
                                        <Button scale className={cx('common_logo')} leftIcon={<NotificationsIcon />}>
                                            <span className={cx('common_text')}>Notifications</span>
                                        </Button>

                                        <div className={cx('comon_dot_notify')} />
                                    </div>
                                </div>
                            </Link>
                        </div>
                            ...
                            <Link className={cx('common_link')}>
                                <div className={cx('common_wrapper')}>
                                    <div className={cx('common_wrapper_temp')}>
                                        ...
                                        <Button scale className={cx('common_logo')} leftIcon={<CreateIcon />}>
                                            <div className={cx('common_text')}>Create</div>
                                        </Button>
                                    </div>
                                </div>
