                            ...
                            <div className={cx('news_form')}>
                                ...
                                <div className={cx('news_form_img')}>
                                    <div className={cx('form_img')}>
                                        <img src="https://lh3.googleusercontent.com/tDcaKebAj_hkLCucg3OtzXtSAy98ZQzBeHoWtFueJBBXBpA-7i0KcAx-dMLzBulvmRhR0dw1MEc603tAqvd-wqi8fJwo7caO53muPwg" />
                                    </div>
                                </div>
                                <div className={cx('news_form_desc')}>Desc</div>
                            </div>
                        </div>
                    </div>
                </div>
